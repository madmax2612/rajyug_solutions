...
<div style={{fontSize:16, color:'black',   paddingTop:20}} >{data.Password}</div>  
 ...
 <div className="col-lg-3 col-md-3 col-sm-4" style={{display:'flex'  }} >
  ...
  <div class="col-lg-8 col-sm-12" style={{ display: "flex", flexDirection: "row" , justifyContent:'center',marginTop:30, marginBottom:20}}>
       ...
       <Modal
        ...
        style={{
          ...
          <div  style={{backgroundColor:"#35A3EF", height:33, width:33, borderRadius:80, marginTop:10, marginLeft:220, marginTop:4}}>   <Block style={{color:'white', fontSize:25, marginLeft:4, marginTop:3,fontWieght:"1000"}} /></div>
		 <div style={{fontSize:22, color:"black", fontWeight:'bold', marginLeft:140, paddingTop:10}}> Block Confirmation</div>
         <div style={{fontSize:16, color:"black",  marginLeft:60, paddingTop:30}}> Blocked accounts are automatically signed out from Front  <br />
