...
export default function TableList() {
  ...
  return (
    ...
    <div style={{ height: "100vh", width: '100%' }}>
      ...
      {/* <div class="col-lg-12 col-sm-12">
        <div class="p-1 rounded mt-0 pt-4 pl-3 pr-3" style={{ backgroundColor: '#fff' }}>
          ...
          <div className="row" style={{ display: "flex", flexDirection: "row" }} >
            ...
            {data ? data.map((res) => {
              return (
                ...
                <div class="col-lg-2 col-sm-2"  >
              <div style={{ display: "flex", flexDirection: "row", }} >
                <img style={{ height: 30, width: 30, borderRadius: 60, }}
                  src="https://barefootmedia.co.uk/wp-content/uploads/2016/01/Chris-user-profile.jpg"
                  alt="avatar" />
                <div style={{ marginLeft: 10 }}>
                  <p style={{ marginTop: -5, fontSize: 14, }}>{res.Name} <br />
                    <p style={{ marginTop: -10 }}>Narayan </p>
                  </p>
            ...
            <div className="row" style={{ marginRight: 0, display: 'flex', flexDirection: 'row', justifyContent: 'center' }} >
              <Link to="/admin/useruserview"> <div  style={{ backgroundColor: "#FF9500", height: 30, width: 30, borderRadius: 80, marginTop: 10, marginTop: 0, marginRight: 5, display:'flex', justifyContent:'center', alignItems:'center' }}>   <VisibilityOutlined style={{ color: 'white', fontSize: 20,  fontWieght: "1000" }} /></div></Link>
                <Link to="/admin/uedit"> <div style={{ backgroundColor: "#28D179", height: 30, width: 30, borderRadius: 80, marginTop: 10, marginTop: 0, marginRight: 5,display:'flex', justifyContent:'center', alignItems:'center' }}>   <EditOutlined style={{ color: 'white', fontSize: 20, fontWieght: "1000" }} /></div></Link>
                <div onClick={() => setShow(true)} style={{ backgroundColor: "#FF3B30", height: 30, width: 30, borderRadius: 80, marginTop: 10, marginTop: 0, marginRight: 5,display:'flex', justifyContent:'center', alignItems:'center' }}>   <VisibilityOffOutlined style={{ color: 'white', fontSize: 20, fontWieght: "1000" }} /></div>
                  <Link to="/admin/ublock"><div style={{ backgroundColor: "#099CD4", height: 30, width: 30, borderRadius: 80, marginTop: 10, marginTop: 0 ,display:'flex', justifyContent:'center', alignItems:'center'}}>   <Block style={{ color: 'white', fontSize: 20, fontWieght: "1000" }} /></div></Link>
              </div>
            </div>
            </>
              )
      ...
      {/* <div class="col-lg-12 col-sm-12">
        <div class="p-1 rounded mt-2 pt-4 pl-3 pr-3" style={{ backgroundColor: '#fff' }}>
            ...
            <div class="col-lg-2 col-sm-2"  >
              <div style={{ display: "flex", flexDirection: "row", }} >
                <img style={{ height: 30, width: 30, borderRadius: 60, }}
                  ...
                  alt="avatar" />
                <div style={{ marginLeft: 10 }}>
                  <p style={{ marginTop: -5, fontSize: 14, }}>RamChandra <br />
                    <p style={{ marginTop: -10 }}>Narayan </p>
                  </p>
