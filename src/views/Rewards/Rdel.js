...
<div  className="row m-3 p-4 " style={{backgroundColor:'white' , display:'flex', flexDirection:'row',  marginTop:40}}>
    ...
    <div className='col-lg-4 col-sm-12  '  style={{marginRight:0}}  >
         ...
         <div style={{background:'transparent',borderStyle:'solid', borderWidth:1, borderColor:'#bf891b',height:35, borderRadius:40, marginBottom:15}}>
                  <div style={{height:25, width:25, backgroundColor:'#bf891b', borderRadius:25, margin:5 }}>
                  <StarRate className={classes.icons}  style={{ color:'white', }}/>
                  </div>
               
                <div style={{marginLeft:40, marginBottom:-23, fontSize:15, marginTop:-30, fontWeight:'bolder' }}> Gold</div> 
                <div style={{display:'flex', justifyContent:'flex-end', padding:-6}}>   	<ExpandMore /> </div>	
                </div>
        </div>
