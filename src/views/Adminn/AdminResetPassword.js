...
export default function AdminResetPwd() {
  ...
  return (
    <div>
          ...
          <Card style={{width:700, marginLeft:450, marginRight:500, marginTop:60}}>
           

            <div style={{display:"flex", flex:1, flexDirection:"row", marginBottom:20, marginLeft:130}}>
              ...
              <div style={{marginLeft:'300'}}>
                ...
                <div style={{display:"flex", flex:1, flexDirection:"row", marginBottom:20, marginLeft:130, marginTop:15}}>
             ...
             <div style={{display:"flex", flex:1, flexDirection:"row", marginBottom:30, marginLeft:130, marginTop:15}}>
      ...
      <div style={{display:'flex', flex:1, flexDirection:'row', marginTop:10, marginBottom:60}}>
       <div style={{paddingBottom:30,width:140, height:35, borderWidth:1, borderColor:'black', zIndex:5, borderRadius:30, borderStyle:'solid', backgroundColor:'black', marginLeft:650, }}>
